...
def main(argv):
    ...
    core_obj_files = compile_directory(core_files, build_directory, include_dirs=(options.include_dirs + [core_files]), avr_path=avr_path, arch=options.arch, clock=options.cpu_clock, verbose=options.verbose, simulate=options.simulate)
